...
public class IconUtils {
     ...
     * 获取白天深色天气图标
     */
    public int getDayIconDark(String weather) {
        int imageId;
        switch (weather) {
            case "100":
     ...
     * 获取白天深色天气图标
     */
    public int getNightIconDark(String weather) {
        int imageId;
        switch (weather) {
            case "100":
     ...
     * 获取白天背景
     */
    public int getDayBack(String weather) {
        int imageId;
        if (weather == null){
            weather = "100";
        }
     ...
     * 获取晚上背景
     */
    public int getNightBack(String weather) {
        int imageId;
        switch (weather) {
            case "100":
